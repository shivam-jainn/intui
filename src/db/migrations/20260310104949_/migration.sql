...
CREATE TABLE "QuestionUser" (
    ...
    CONSTRAINT "QuestionUser_pkey" PRIMARY KEY ("questionId","userId")
);
...
-- AddForeignKey
ALTER TABLE "QuestionUser" ADD CONSTRAINT "QuestionUser_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "Question"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuestionUser" ADD CONSTRAINT "QuestionUser_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
